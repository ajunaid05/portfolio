...
Rather than relying on silent third-party form processors that often fail or drop submissions, this feature provides a direct, zero-friction communication bridge. When a recruiter or visitor clicks **Send Email (via Gmail)** on the live portfolio, it dynamically triggers Google's Gmail web compose interface with my recipient email address (`ahmadjuniad007.07@gmail.com`) prefilled in the `To:` field.
...
[ User Clicks "Send Email" ] 
         │
         ▼
[ Encoded URI Generator ] ──> https://mail.google.com/mail/?view=cm&fs=1&to=ahmadjuniad007.07@gmail.com
         │
         ▼
[ Browser / Protocol Handler ]
         │
         ▼
[ Gmail Web / Mobile App Launch ] (Pre-fills Recipient: ahmadjuniad007.07@gmail.com)
         │
         ▼
...
2. **URL Parameter Encoding:** The React component dynamically generates an explicit Google Mail compose URI:  
   `https://mail.google.com/mail/?view=cm&fs=1&to=ahmadjuniad007.07@gmail.com`
...
4. **Context Injection:** The recipient parameter (`to=ahmadjuniad007.07@gmail.com`) is injected into the composer's "To" field.
...
- **Evidence:** Clicking the button successfully launches Gmail with `ahmadjuniad007.07@gmail.com` prefilled, allowing any visitor or recruiter to send a real message that arrives directly in my inbox.
