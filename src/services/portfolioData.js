  ...
  about: {
    ...
    pillars: [
      ...
      },
      {
        ...
        description: "Building responsive React.js interfaces, managing application state, and deploying end-to-end applications to Netlify & Vercel over HTTPS."
      }
    ]
  },
  experience: [
    {
      ...
      bullets: [
        ...
        "Executing full-stack assignments involving zero-downtime deployment on Netlify & Vercel over public HTTPS.",
